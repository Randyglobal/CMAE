              ...
              <tr>
                ...
                <td className="px-5 py-4 text-sm font-medium whitespace-nowrap text-gray-800 dark:text-white/90">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">AMX-500 • 500 mg</div>
                  </div>
                </td>
                <td className="px-5 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                  1
              ...
              <tr>
                ...
                <td className="px-5 py-4 text-sm font-medium whitespace-nowrap text-gray-800 dark:text-white/90">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">PCM-500 • 500 mg</div>
                  </div>
                </td>
                <td className="px-5 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                  1
              ...
              <tr>
                ...
                <td className="px-5 py-4 text-sm font-medium whitespace-nowrap text-gray-800 dark:text-white/90">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">IBP-200 • 200 mg</div>
                  </div>
                </td>
                <td className="px-5 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                  2
              ...
              <tr>
                ...
                <td className="px-5 py-4 text-sm font-medium whitespace-nowrap text-gray-800 dark:text-white/90">
                  <div>
                    ...
                    <div className="text-xs text-gray-500">MTF-850 • 850 mg</div>
                  </div>
                </td>
                <td className="px-5 py-4 text-sm whitespace-nowrap text-gray-500 dark:text-gray-400">
                  1
        ...
        <div className="mt-6 w-full space-y-1 text-right sm:w-[220px]">
          ...
          <ul className="space-y-2">
            <li className="flex justify-between gap-5">
              ...
              <span className="text-sm font-medium text-gray-700 dark:text-gray-400">$61.00</span>
            </li>
            <li className="flex items-center justify-between">
              <span className="text-sm text-gray-500 dark:text-gray-400">Vat (10%):</span>
              <span className="text-sm font-medium text-gray-700 dark:text-gray-400">$6.10</span>
            </li>
            <li className="flex items-center justify-between">
              <span className="font-medium text-gray-700 dark:text-gray-400">Total</span>
              <span className="text-lg font-semibold text-gray-800 dark:text-white/90">$67.10</span>
            </li>
          </ul>
        </div>
      </div>
