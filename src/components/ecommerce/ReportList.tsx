...
interface SortState {
  key: "patientName" | "doctorName" | "date";
  asc: boolean;
}

const initialTransactions: Report[] = [
  {
    id: 1,
    reportId: "RPT-1001",
    patientName: "Lindsey Curtis",
    patientId: "P-3421",
    doctorName: "Dr. Aaron Blake",
    doctorId: "D-110",
    statement: "Routine blood test — all markers within normal range.",
    status: "Completed",
    date: "12 Feb, 2028",
  },
  {
    id: 2,
    reportId: "RPT-1002",
    patientName: "Kaiya George",
    patientId: "P-3422",
    doctorName: "Dr. Nina Shah",
    doctorId: "D-112",
    statement: "Follow-up: elevated blood pressure — started on medication.",
    status: "In Progress",
    date: "13 Mar, 2028",
  },
  {
    id: 3,
    reportId: "RPT-1003",
    patientName: "Zain Geidt",
    patientId: "P-3423",
    doctorName: "Dr. Aaron Blake",
    doctorId: "D-110",
    statement: "X-ray shows no acute fracture. Recommend rest and review.",
    status: "Completed",
    date: "19 Mar, 2028",
  },
  {
    id: 4,
    reportId: "RPT-1004",
    patientName: "Abram Schleifer",
    patientId: "P-3424",
    doctorName: "Dr. Lina Gomez",
    doctorId: "D-115",
    statement: "ICU: patient under observation for respiratory distress.",
    status: "Critical",
    date: "25 Apr, 2028",
  },
  {
    id: 5,
    reportId: "RPT-1005",
    patientName: "Carla George",
    patientId: "P-3425",
    doctorName: "Dr. Nina Shah",
    doctorId: "D-112",
    statement: "Physical exam normal. Routine vaccination given.",
    status: "Completed",
    date: "11 May, 2028",
  },
  {
    id: 6,
    reportId: "RPT-1006",
    patientName: "Emery Culhane",
    patientId: "P-3426",
    doctorName: "Dr. Aaron Blake",
    doctorId: "D-110",
    statement: "Medication reviewed; no changes recommended.",
    status: "Completed",
    date: "29 Jun, 2028",
  },
  {
    id: 7,
    reportId: "RPT-1007",
    patientName: "Livia Donin",
    patientId: "P-3427",
    doctorName: "Dr. Lina Gomez",
    doctorId: "D-115",
    statement: "Allergy testing pending; sample collected.",
    status: "In Progress",
    date: "22 Jul, 2028",
  },
  {
    id: 8,
    reportId: "RPT-1008",
    patientName: "Miracle Bator",
    patientId: "P-3428",
    doctorName: "Dr. Aaron Blake",
    doctorId: "D-110",
    statement: "Discharged with follow-up appointment in 2 weeks.",
    status: "Completed",
    date: "05 Aug, 2028",
  },
];
...
const ReportList: React.FC = () => {
  const [transactions] = React.useState<Report[]>(initialTransactions);
  ...
  const sortedRows: Report[] = React.useMemo(() => {
  ...
  const filteredRows: Report[] = useMemo(() => {
      ...
      <div className="flex items-center justify-between border-b border-gray-200 px-5 py-4 dark:border-gray-800">
        <div>
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Recent clinical reports and summaries for patients
          </p>
        </div>
              ...
              >
                ...
                <td className="p-4 whitespace-nowrap">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">{row.patientId}</p>
                  </div>
                </td>
                <td className="p-4 whitespace-nowrap">
                  <div>
                    ...
                    <p className="text-xs text-gray-500 dark:text-gray-400">{row.doctorId}</p>
                  </div>
                </td>
                ...
                <td className="p-4 whitespace-nowrap">
                  <p className="text-sm text-gray-700 dark:text-gray-400">{row.date}</p>
                </td>
                <td className="p-4 whitespace-nowrap">
                  <span
                    ...
                    <TableDropdown
                      ...
                      dropdownContent={
                        <>
                              ...
                              <button
                                onClick={() => alert('Mark resolved (mock)')}
                                className="text-xs flex w-full rounded-lg px-3 py-2 text-left font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-700 dark:text-gray-400 dark:hover:bg-white/5 dark:hover:text-gray-300"
                              >
                                Mark Resolved
                              </button>
