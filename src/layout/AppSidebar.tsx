...
import bgImage from "../assets/img/signinBG.png";
...
const navItems: NavItem[] = [
  ...
  },
  {
    ...
    subItems: [
      ...
      { name: "Patients", path: "/users/patients" },
    ],
  },
  {
    name: "Medicines",
    ...
    new: true,
    subItems: [
      { name: "Category", path: "/medicine/categories" },
      { name: "Class", path: "/medicine/classes" },
      { name: "Stocks", path: "/products-list" },
        ...
        if (nav.subItems) {
          nav.subItems.forEach((subItem) => {
            if (isActive(subItem.path)) {
              setOpenSubmenu({ type: menuType as "main" | "support", index });
              submenuMatched = true;
            }
          });
        }
    ...
    >
      ...
      >
        <Link to="/" className="flex items-center gap-2 mb-4">
          ...
          />
          <span className="font-semibold text-gray-700 text-2xl mt-4 dark:text-white">CMAE</span>
        </Link>
      </div>
